...
**xml** est un langage de balisage utilisé pour stocker et partager des données de manière structurer
...
## Version d'un xml avec des attributs
...
> CDATA permet d'inclure du texte qui pourrait contenir des caractères spéciaux. Faire des CDATA quand on a un bloc de texte à intégrer.

## Les namespaces sert à éviter les conflits de noms

<?xml version="1.0" encoding="UTF-8"?>

<catalogue xmlns:film="http://mabibli.fr/films"
xmlns:livre="http://mabibli.fr/livres"
